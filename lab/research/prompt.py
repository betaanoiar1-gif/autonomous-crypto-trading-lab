...
def build_prompt(market_snapshot: dict, prior_failures: list[dict], max_hypotheses: int = 1, prior_hypotheses: list[dict] | None = None) -> str:
    payload = {
        ...
        "diversity_rule": "Prefer a different family, mechanism, symbol or direction from previous hypotheses.",
        "parameter_rules": {
